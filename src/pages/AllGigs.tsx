...
export default function AllGigs({ searchQuery, activeCategory }: AllGigsProps) {
  ...
  }, [t, searchQuery, activeCategory]) // Add activeCategory to dependencies
  ...
  // Filter on searchQuery (now redundant as API handles filtering)
  useEffect(() => {
    setFilteredGigs(gigs) // gigs is already filtered by category and search from API
  }, [searchQuery, gigs])
